(function()
{
	...
	{
		if (editor && isEnter && (editor instanceof TF.DetailView.FieldEditor.StringFieldEditor || editor instanceof TF.DetailView.FieldEditor.DateFieldEditor) && !editor._$element.find("input").val())
		{
