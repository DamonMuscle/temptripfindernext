(function()
{
	...
	BaseGridPage.prototype.navClick = function(model, element)
	{
		...
		this.initScheduler(this, this.$element.find(".kendoscheduler"));
	};

	BaseGridPage.prototype.initScheduler = function(model, $element)
	{
		var self = this, option = this.$element.find(".stage-option");
				...
				resources: [
					{
						field: "stageId",
						title: "Trip Stage",
						dataSource: eval(schedulerResources)
					}
				]
			});
