(function()
{
	createNamespace("TF.RoutingMap").DirectionPaletteViewModel_SELF = DirectionPaletteViewModel;
	...
	DirectionPaletteViewModel.prototype.buildDestinationSearches = function()
	{
		...
		self.obDestinationsArray().forEach(function(destItem, idx)
		{
			...
			var search = new self.ArcGisSearch({
				...
				sources: [
					{
						locator: new self.ArcGisLocator({
							url: arcgisUrls.StreetGeocodeServiceFile
						}),
