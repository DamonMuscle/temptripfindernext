(function()
{
	createNamespace("TF.RoutingMap.MapEditingPalette").WaterLockData = WaterLockData;

	function WaterLockData(dataModel)
	{
		var options = {};
	...
	WaterLockData.prototype = Object.create(TF.RoutingMap.LockData.prototype);
	WaterLockData.prototype.constructor = WaterLockData;

	WaterLockData.prototype.refreshOtherChangeData = function(refreshIds)
	{
		var self = this;
		var deleteData = [];
	...
	WaterLockData.prototype.saveData = function(changeData)
	{
		var self = this;
		var updatedRecords = [];
