								...
								.then(function(isValidate)
								{
									...
									if (!isValidate)
									{
										...
										return tf.promiseBootbox.dialog({
											message: "This Data Source (" + databaseName + ") needs to be rebuilt before it can be opened in " + TF.productName + ". To rebuild this Data Source, open it in Routefinder Pro.",
											title: "Alert",
											closeButton: true,
											buttons: {
												ok: {
